...
# It makes assumptions about the order of the command line arguments and has no parsing.

# Run using: 
#
#   perl wrap_pi_tar.pl pvmem=2gb nodes=1:ppn=1 walltime=00:01:00 pi pi.input
